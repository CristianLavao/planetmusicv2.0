...
mysqli_query($db,"UPDATE Articulos SET nombre='$nombre', fecha_entrada='$fecha', precio='$precio', cantidad='$cantidad', imagen='$imagen', categorias_id_categoria='$iidcategoria', proveedores_id_proveedor='$iidproveedor' WHERE id_articulo='$idart'")
