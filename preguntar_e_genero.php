...
<table width="900" border="0" align="center">
  ...
  <tr>
    ...
    <form id="form1" name="form1" method="post" action="editar_genero.php">
      <table width="500" border="1">
        <tr>
          <td width="207">Seleccione el genero que desea modificar</td>
          ...
          <option disabled></option>
			...
			while($row = $result->fetch_assoc())
			{
				...
				echo "<option value=".$iidgen.">".$nnombre."</option>";
				}
            ?>
