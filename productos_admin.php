...
<table width="900" border="0" align="center">
  ...
  <tr>
	...
	<iframe src="menu_admin.php" frameborder="0" width="880" height="100">   </iframe>
...
while($row = $result->fetch_assoc())
{
    ...
    &nbsp;</p>
    <p><a href="index_admin.php">INICIO</a></p></td>
  </tr>
