...
<form id="form1" name="form1" method="post" action="neg_eliminar_usuario.php">
<?php
...
?>
      ...
      <tr>
        ...
        ¿Seguro desea eliminar el usuario <input name="usuario" type="hidden" value=<?php echo $usuario; ?> />
        </td>
       </tr>
       <tr>
       	<td align="center">
      ...
      <p><a href="eliminar_e_usuario.php">Cancelar</a></p>
    </form>   
