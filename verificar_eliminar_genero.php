...
<form id="form1" name="form1" method="post" action="neg_eliminar_genero.php">
<?php
...
?>
      ...
      <tr>
        ...
        ¿Seguro desea eliminar el genero seleccionado? <input name="generos" type="hidden" value=<?php echo $generos; ?> />
        </td>
       </tr>
       <tr>
       	<td align="center">
      ...
      <p><a href="eliminar_e_genero.php">Cancelar</a></p>
    </form>   
