...
<table width="900" border="0" align="center" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <form id="form1" name="form1" method="post" action="verificar_eliminar_productos.php">
      <table width="500" border="1">
        <tr>
          <td width="207">Seleccione el articulo que desea eliminar</td>
          <td width="150"><select name="articulos" id="articulos" required>
          ...
          <option disabled></option>
			...
			while($row = $result->fetch_assoc())
			{
				...
				$nnombreart=stripslashes($row["nombre"]);
				echo "<option value=".$iidarticulos.">".$nnombreart."</option>";
				}
            ?>
