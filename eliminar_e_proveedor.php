...
<table width="900" border="0" align="center">
  ...
  <tr>
    ...
    <form id="form1" name="form1" method="post" action="verificar_eliminar_proveedor.php">
      <table width="500" border="1">
        <tr>
          <td width="207">Seleccione el proveedor que desea eliminar</td>
          <td width="150"><select name="proveedor" id="proveedor" required>
          ...
          <option disabled></option>
			...
			while($row = $result->fetch_assoc())
			{
				...
				echo "<option value=".$iidproveedor.">".$nnombrepro."</option>";
				}
            ?>
