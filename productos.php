...
<table width="900" border="0" align="center">
  <tr>
	...
	<iframe src="banner.php" frameborder="0" width="990" height="170" scrolling="no">    </iframe>
  ...
  <tr>
    <td colspan="3"><iframe src="slider.php" frameborder="0" width="1000" height="450" scrolling="no">   </iframe></td>
  </tr>
  <tr>
    <td  width="150" height="150" bgcolor="#CCCCCC" ><iframe  src="publicidad.php" frameborder="0" width="250" height="300">   </iframe></td>
...
while($row = $result->fetch_assoc())
{
    ...
    <p bgcolor="#CCCCCC"><a href="index.php">INICIO</a></p>
  <tr>
    <td  colspan="3" ><p>
	<iframe src="footer.php" frameborder="0" width="890" height="270" scrolling="no">   </iframe>
	</p>
    </td>
  </tr>
</table>
