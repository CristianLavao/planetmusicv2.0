...
<form id="form1" name="form1" method="post" action="neg_eliminar_proveedor.php">
<?php
...
?>
      ...
      <tr>
        ...
        ¿Seguro desea eliminar el proveedor seleccionado? <input name="proveedores" type="hidden" value=<?php echo $proveedor; ?> />
        </td>
       </tr>
       <tr>
       	<td align="center">
      ...
      <p><a href="eliminar_e_proveedor.php">Cancelar</a></p>
    </form>   
