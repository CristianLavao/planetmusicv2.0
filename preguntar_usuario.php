...
<table width="900" border="0" align="center">
  ...
  <tr>
    ...
    <td width="724" colspan="2"><form id="form1" name="form1" method="post" action="datos_listar_usuario_individual.php">
      <table width="419" border="1">
        <tr>
          ...
          <option disabled></option>
			...
			{
				$idusuario=stripslashes($row["id_usuario"]);
				$nomusuario=stripslashes($row["nombre_de_usuario"]);
				echo "<option value=".$idusuario.">".$nomusuario."</option>";
				}
            ?>
