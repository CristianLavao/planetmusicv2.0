...
<table width="900" border="0" align="center">
  ...
  <tr>
    ...
    <form id="form1" name="form1" method="post" action="verificar_eliminar_genero.php">
      <table width="500" border="1">
        <tr>
          <td width="207">Seleccione el genero que desea eliminar</td>
          <td width="150"><select name="generos" id="generos" required>
          <option value="" selected>Seleccione...</option>
			...
			while($row = $result->fetch_assoc())
			{
				...
				echo "<option value=".$iidcate.">".$nnombre."</option>";
				}
            ?>
